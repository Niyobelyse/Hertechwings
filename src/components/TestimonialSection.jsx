const testimonials = [
  {
    id: 1,
    name: "Aline Mukamana",
    company: "HerTechWings Alumni",
    image: "images/aline.jpeg",
    text: "HerTechWings gave me the skills and confidence to start my career in tech. The mentorship and resources provided were invaluable!",
    rating: 5,
  },
  {
    id: 2,
    name: "Nadine Uwera",
    company: "Junior Developer at KigaliTech",
    image: "images/nadine.jpeg",
    text: "Through HerTechWings, I gained practical coding skills and landed my first job in software development. I highly recommend it!",
    rating: 5,
  },
  {
    id: 3,
    ...
    image: "images/ishimwe.jpeg",
    text: "This platform empowered me to turn my ideas into a real business. The support and learning experience were phenomenal!",
    rating: 5,
  },
];
      ...
      <div className="grid md:grid-cols-2 gap-12 items-start">
        <div>
          <h2 className="text-4xl font-bold text-gray-900 leading-tight">
            What Our Beneficiaries Say About HerTechWings
          </h2>
        </div>
      </div>
