          ...
          <div key={member.id} className="bg-white rounded-lg overflow-hidden shadow-sm">
            ...
            <div className="p-4">
              ...
              <div className="flex space-x-2 mt-4">
                <a href="#" className="bg-pink-400 text-white p-2 rounded-full hover:bg-pink-700 transition-colors">
                ...
                <a href="#" className="bg-pink-400 text-white p-2 rounded-full hover:bg-pink-500 transition-colors">
                  <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" className="bg-pink-400 text-white p-2 rounded-full hover:bg-pink-800 transition-colors">
                  <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22 12a10 10 0 1 0-11 9.95V15h-2v-3h2V9.5a3 3 0 0 1 3-3h2v3h-2a1 1 0 0 0-1 1V12h3l-1 3h-2v6.95A10 10 0 0 0 22 12z" />
                  </svg>
                </a>
